  ...
  return (
    <>
      <footer className="footer" >
          ...
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/tyagignikhil/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://twitter.com/NikhilTyagiG" target="blank">
                  <FaTwitter className=" mx-auto mt-3 scale-125" />
                </a>

                <a href="https://www.instagram.com/mr_nikhiltyagi/" target="blank">
        ...
        <p className="text-white text-2xl my-2  ">Made with 🤍 By Nikhil © 2024</p>
        <div className=" ">
